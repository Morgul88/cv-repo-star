  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>Hanterar och åtgärdar driftstopp och tekniska problem i anläggningen.</li>
        <li>Arbetar aktivt för att minska miljöpåverkan och säkerställa att utsläppsvillkor för fosfor, kväve och BOD7 följs.</li>
        <li>Bidrar till att utveckla och förbättra reningsprocessen för att klara framtida miljökrav.</li>
      </ul>
      
      <p>Gryaab har ett stort fokus på hållbarhet och har certifieringar som ISO 14001 och Revaq för att säkerställa att verksamheten bedrivs med största möjliga hänsyn till miljön. Driftteknikerna spelar en avgörande roll i att upprätthålla dessa standarder genom att kontinuerligt övervaka och förbättra reningsprocesserna.</p>
    </div>
  )
}

export default Gryaab
